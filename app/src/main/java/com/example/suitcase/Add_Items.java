...
public class Add_Items extends AppCompatActivity {
    ...
    // intent method for click and jump to another activity
    ...
    // add item method and from validation also
    private void saveItem(View view){
        ...
        try {
            ...
            Toast.makeText(this, "Something wrong with price", Toast.LENGTH_SHORT);
