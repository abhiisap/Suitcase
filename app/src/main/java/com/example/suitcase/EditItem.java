...
ActivityEditItemBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(this, "Error occured in identifying", Toast.LENGTH_SHORT).show();
        }
    ...
    private void saveItem(View view){
        ...
        try {
            ...
            Toast.makeText(this,"Something wrong with the price", Toast.LENGTH_SHORT).show();
